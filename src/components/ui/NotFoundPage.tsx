...
export default function NotFoundPage() {
  return (
    <PageTransition className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      ...
      <h1 data-fc-id="NotFound-title" className="text-4xl font-bold text-white mb-2">404</h1>
      ...
      <Link
        ...
        to="/"
        className="inline-flex items-center gap-2 px-5 py-2.5 bg-accent-600 hover:bg-accent-500 text-white text-sm font-medium rounded-lg transition-colors"
      >
